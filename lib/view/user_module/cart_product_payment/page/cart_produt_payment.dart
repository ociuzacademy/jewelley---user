...
class UserCartPayment extends StatefulWidget {
  ...
  @override
  UserCartPaymentState createState() => UserCartPaymentState();
}

class UserCartPaymentState extends State<UserCartPayment> {
  String? selectedBank;
  ...
  Future<void> _cardpay() async {
    if (_formKey.currentState!.validate()) {
      try {
        final responseMessage = await cartCardPayService(
